...
class Zombie {
  ...
  render(){
    ...
    //Add animations
    let idleRight = this.sprite.animations.add('idleRight', [2]);
    let idleLeft = this.sprite.animations.add('idleLeft', [4]);
    let runRight = this.sprite.animations.add('runRight', [0,1,2], 5, true);
    let runLeft = this.sprite.animations.add('runLeft', [4,5,6], 5, true);
